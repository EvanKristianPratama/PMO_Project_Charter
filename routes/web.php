...
Route::middleware(["auth", "approved"])->group(function () {
    ...
    Route::get("/program-planning", PlanningDashboardController::class)->name(
        "program-planning",
    );
    ...
    Route::put(
        ...
        ->whereNumber("digitalInitiative")
        ->name(
            "program-planning.program-definition.digital-initiatives.update",
        );
    Route::get(
        ...
        ->name(
            "program-planning.program-definition.digital-initiatives.summary.index",
        );
    ...
    Route::prefix(
        ...
        ->group(function () {
            Route::get(
                "/",
                ProgramDefinitionDigitalInitiativesAppendixIndexController::class,
            )->name("index");
            Route::get(
                "/create",
                ProgramDefinitionDigitalInitiativesAppendixCreateController::class,
            )->name("create");
            Route::post(
                "/",
                ProgramDefinitionDigitalInitiativesAppendixStoreController::class,
            )->name("store");
            Route::get(
                "/{scInitiative}/edit",
                ProgramDefinitionDigitalInitiativesAppendixEditController::class,
            )->name("edit");
            Route::put(
                "/{scInitiative}",
                ProgramDefinitionDigitalInitiativesAppendixUpdateController::class,
            )->name("update");
        });
    Route::prefix(
        ...
        ->group(function () {
            Route::get(
                "/",
                ProgramDefinitionDigitalInitiativesCompendiumIndexController::class,
            )->name("index");
            Route::get(
                "/create",
                ProgramDefinitionDigitalInitiativesCompendiumCreateController::class,
            )->name("create");
            Route::post(
                "/",
                ProgramDefinitionDigitalInitiativesCompendiumStoreController::class,
            )->name("store");
            Route::get(
                "/{scInitiative}/edit",
                ProgramDefinitionDigitalInitiativesCompendiumEditController::class,
            )->name("edit");
            Route::put(
                "/{scInitiative}",
                ProgramDefinitionDigitalInitiativesCompendiumUpdateController::class,
            )->name("update");
        });
    Route::get(
        ...
        "program-planning.program-definition.digital-initiatives.mapping.index",
    );
    Route::get(
        ...
        "program-planning.program-definition.digital-initiatives.master.index",
    );
    Route::prefix(
        "/program-planning/program-definition/digital-initiatives/roadmap",
    )
        ->name(
            "program-planning.program-definition.digital-initiatives.roadmap.",
        )
        ->group(function () {
            Route::get(
                "/",
                ProgramDefinitionDigitalInitiativesRoadmapIndexController::class,
            )->name("index");
            Route::get(
                "/create",
                ProgramDefinitionDigitalInitiativesRoadmapCreateController::class,
            )->name("create");
            Route::get(
                "/edit",
                ProgramDefinitionDigitalInitiativesRoadmapEditController::class,
            )->name("edit");
            Route::post("/", [
                ProgramDefinitionDigitalInitiativesRoadmapMilestoneController::class,
                "store",
            ])->name("store");
            Route::put("/{masterMilestone}", [
                ProgramDefinitionDigitalInitiativesRoadmapMilestoneController::class,
                "update",
            ])->name("update");
            Route::delete("/{masterMilestone}", [
                ProgramDefinitionDigitalInitiativesRoadmapMilestoneController::class,
                "destroy",
            ])->name("destroy");
        });
    ...
    Route::prefix("/master-data/business-capabilities")
        ->name("master-data.business-capabilities.")
        ->group(function () {
            Route::get("/", [
            ...
            Route::put("/{businessCapability}", [
                BusinessCapabilityController::class,
                "update",
            ])->name("update");
            Route::delete("/{businessCapability}", [
                BusinessCapabilityController::class,
                "destroy",
            ])->name("destroy");
        });
    ...
    Route::redirect(
        ...
        "/strategic-house/initiative-relation",
    );
    Route::prefix("/strategic-house/initiative-relation")
        ->name("initiative-relations.")
        ->group(function () {
            Route::get("/", [
                StrategicHouseInitiativeRelationController::class,
                "index",
            ])->name("index");
            Route::get("/create", [
                StrategicHouseInitiativeRelationController::class,
            ...
            Route::post("/sync-positions", [
                StrategicHouseInitiativeRelationController::class,
                "syncPositions",
            ])->name("sync-positions");
            Route::get("/{initiativeRelation}/edit", [
                StrategicHouseInitiativeRelationController::class,
                "edit",
            ])
                ->whereNumber("initiativeRelation")
                ->name("edit");
            Route::get("/{initiativeRelation}", [
                StrategicHouseInitiativeRelationController::class,
                "show",
            ])
                ->whereNumber("initiativeRelation")
                ->name("show");
            Route::put("/{initiativeRelation}", [
                StrategicHouseInitiativeRelationController::class,
                "update",
            ])
                ->whereNumber("initiativeRelation")
                ->name("update");
            Route::delete("/{initiativeRelation}", [
                StrategicHouseInitiativeRelationController::class,
                "destroy",
            ])
                ->whereNumber("initiativeRelation")
    ...
    Route::get(
        ...
        static fn() => redirect("/strategic-house/initiative-relation"),
    );
    Route::get(
        "/program-planning/initiative-relation/create",
        static fn() => redirect("/strategic-house/initiative-relation/create"),
    );
    Route::get(
        "/program-planning/initiative-relation/{initiativeRelation}/edit",
        [StrategicHouseInitiativeRelationController::class, "edit"],
    )->whereNumber("initiativeRelation");
    Route::get("/program-planning/initiative-relation/{initiativeRelation}", [
        StrategicHouseInitiativeRelationController::class,
        "show",
    ])->whereNumber("initiativeRelation");
    Route::post("/program-planning/initiative-relation", [
        StrategicHouseInitiativeRelationController::class,
        "store",
    ]);
    Route::put("/program-planning/initiative-relation/{initiativeRelation}", [
        StrategicHouseInitiativeRelationController::class,
        "update",
    ])->whereNumber("initiativeRelation");
    Route::delete(
        "/program-planning/initiative-relation/{initiativeRelation}",
        [StrategicHouseInitiativeRelationController::class, "destroy"],
    )->whereNumber("initiativeRelation");
    Route::redirect(
    ...
    Route::redirect(
        "/program-implementation/initiative-relation/create",
        "/strategic-house/initiative-relation/create",
    );
    Route::get(
        "/program-implementation/initiative-relation/{initiativeRelation}/edit",
        static function (string $initiativeRelation) {
            return redirect(
                "/strategic-house/initiative-relation/{$initiativeRelation}/edit",
            );
        },
    );
    Route::get(
    ...
    Route::redirect(
        "/program-implementation/it-building-blocks",
        "/program-planning/it-building-blocks",
    );
    Route::post("/program-implementation/it-building-blocks", [
        StrategicHouseItBuildingBlockController::class,
        "store",
    ]);
    Route::redirect(
        "/program-implementation/it-building-blocks/primary/{primary}",
        "/program-planning/it-building-blocks",
    );
    Route::redirect(
        "/program-implementation/it-building-blocks/primary/{primary}/secondary/{secondary}",
        "/program-planning/it-building-blocks",
    );
    ...
    Route::get(
        "/business-process",
        fn() => redirect()->route("business-process.proses-bisnis.index"),
    ...
    Route::delete(
        ...
        [
            BusinessProcessOrganizationStructureController::class,
            "destroyFunctionalMember",
        ],
    )->name(
        "business-process.organization-structure.functional.member.destroy",
    );
    Route::post(
        "/business-process/organization-structure/functional/structure",
        [
            BusinessProcessOrganizationStructureController::class,
            "storeFunctionalStructure",
        ],
    )->name(
        "business-process.organization-structure.functional.structure.store",
    );
    Route::delete(
        "/business-process/organization-structure/functional/structure",
        [
            BusinessProcessOrganizationStructureController::class,
            "destroyFunctionalStructure",
        ],
    )->name(
        "business-process.organization-structure.functional.structure.destroy",
    );
    Route::get(
        "/business-process/informatic-system",
        fn() => Inertia::render("BusinessProcess/InformaticSystem/Index"),
    ...
    Route::get(
        ...
        fn() => redirect()->route("resource-management.index"),
    ...
    Route::prefix("/resource-management")
        ...
        ->group(function () {
            Route::get("/", [
                MainResourceManagementController::class,
                "index",
            ])->name("index");
            Route::post("/", [
                MainResourceManagementController::class,
    ...
    Route::prefix("/policy")
        ...
        ->group(function () {
            ...
            Route::get("/guidance/introduction", [
                GeneralPolicyController::class,
                "introduction",
            ])->name("guidance.introduction");
            Route::get("/guidance/closing", [
                GeneralPolicyController::class,
                "closing",
            ])->name("guidance.closing");
            ...
            Route::get("/specific/manage", [
                PolicyController::class,
                "manage",
            ])->name("specific.manage");
            Route::get("/specific/create", [
                PolicyController::class,
                "createObjective",
            ])->name("specific.create");
            Route::get("/specific/{objective}/edit", [
                PolicyController::class,
                "editObjective",
            ])->name("specific.edit");
            Route::get("/specific/mapping-all", [
                PolicyController::class,
                "mappingCobit",
            ])->name("specific.mapping");
            Route::get("/specific/mapping-analysis", [
                PolicyController::class,
                "mappingCobitAnalysis",
            ])->name("specific.mapping.analysis");
            Route::post("/objective", [
                PolicyController::class,
                "storeObjective",
            ])->name("objective.store");
            Route::put("/objective/{objective}", [
                PolicyController::class,
                "updateObjective",
            ])->name("objective.update");
            Route::delete("/objective/{objective}", [
                PolicyController::class,
                "destroyObjective",
            ...
            Route::put("/practice/{practice}", [
                PolicyController::class,
                "updatePractice",
            ])->name("practice.update");
            Route::delete("/practice/{practice}", [
                PolicyController::class,
                "destroyPractice",
            ])->name("practice.destroy");

            // Mapping COBIT 2019
            Route::post("/cobit-mapping", [
                PolicyController::class,
                "storeCobitMapping",
            ])->name("cobit-mapping.store");
            Route::put("/cobit-mapping/{id}", [
                PolicyController::class,
                "updateCobitMapping",
            ])->name("cobit-mapping.update");
            Route::delete("/cobit-mapping/{id}", [
                PolicyController::class,
                "destroyCobitMapping",
            ])->name("cobit-mapping.destroy");
            ...
            Route::put("/roles/role/{role}", [
                RoleController::class,
                "updateRole",
            ])->name("roles.role.update");
            Route::delete("/roles/role/{role}", [
                RoleController::class,
                "destroyRole",
            ])->name("roles.role.destroy");
            Route::post("/roles/responsibility", [
                RoleController::class,
                "storeResponsibility",
            ])->name("roles.responsibility.store");
            Route::put("/roles/responsibility/{responsibility}", [
                RoleController::class,
                "updateResponsibility",
            ])->name("roles.responsibility.update");
            Route::delete("/roles/responsibility/{responsibility}", [
                RoleController::class,
                "destroyResponsibility",
            ])->name("roles.responsibility.destroy");

            // Mapped Responsibles from Master Data
            Route::post("/roles/mapped-responsible", [
                RoleController::class,
                "storeMappedResponsible",
            ])->name("roles.mapped-responsible.store");
            Route::delete(
                "/roles/mapped-responsible/{roleId}/{responsibleId}",
                [RoleController::class, "destroyMappedResponsible"],
            )->name("roles.mapped-responsible.destroy");
            Route::post("/roles/responsible-practice", [
                RoleController::class,
                "updateResponsiblePractice",
            ])->name("roles.responsible-practice.update");
            Route::post("/roles/objective-responsible/{objectiveId}", [
                RoleController::class,
                "updateObjectiveResponsibles",
            ])->name("roles.objective-responsible.update");

            // Regulasi (Regulation) CRUD
            Route::get("/regulation/{id}/preview", [
                RegulationController::class,
                "previewData",
            ])->name("regulation.preview");
            Route::get("/regulation", [
                RegulationController::class,
                "index",
            ])->name("regulation.index");
            Route::get("/sk", [RegulationController::class, "skIndex"])->name(
                "sk.index",
            );
            Route::post("/regulation", [
                RegulationController::class,
                "store",
            ])->name("regulation.store");
            Route::put("/regulation/{id}", [
                RegulationController::class,
                "update",
            ])->name("regulation.update");
            Route::delete("/regulation/{id}", [
                RegulationController::class,
                "destroy",
            ])->name("regulation.destroy");
            ...
            Route::get("/procedure/manage", [
                ProcedureController::class,
                "manage",
            ])->name("procedure.manage");
            Route::post("/procedure/actor", [
                ProcedureController::class,
                "storeActor",
            ])->name("procedure.actor.store");
            Route::put("/procedure/actor/{id}", [
                ProcedureController::class,
                "updateActor",
            ])->name("procedure.actor.update");
            Route::delete("/procedure/actor/{id}", [
                ProcedureController::class,
                "destroyActor",
            ])->name("procedure.actor.destroy");
            Route::post("/procedure/category", [
                ProcedureController::class,
                "storeCategory",
            ])->name("procedure.category.store");
            Route::put("/procedure/category/{id}", [
                ProcedureController::class,
                "updateCategory",
            ])->name("procedure.category.update");
            Route::delete("/procedure/category/{id}", [
                ProcedureController::class,
                "destroyCategory",
            ])->name("procedure.category.destroy");
            Route::post("/procedure/sop", [
                ProcedureController::class,
                "storeSop",
            ])->name("procedure.sop.store");
            Route::put("/procedure/sop/{id}", [
                ProcedureController::class,
                "updateSop",
            ])->name("procedure.sop.update");
            Route::delete("/procedure/sop/{id}", [
                ProcedureController::class,
                "destroySop",
            ])->name("procedure.sop.destroy");
            Route::post("/procedure/diagram", [
                ProcedureController::class,
                "storeDiagram",
            ])->name("procedure.diagram.store");
            Route::put("/procedure/diagram/{id}", [
                ProcedureController::class,
                "updateDiagram",
            ])->name("procedure.diagram.update");
            Route::delete("/procedure/diagram/{id}", [
                ProcedureController::class,
                "destroyDiagram",
            ])->name("procedure.diagram.destroy");
            Route::post("/procedure/tko-content", [
                ProcedureController::class,
                "storeOrUpdateTkoContent",
            ])->name("procedure.tko-content.store");
            Route::post("/procedure/tko-content/save-structured", [
                ProcedureController::class,
                "saveStructuredDocument",
            ])->name("procedure.tko-content.save-structured");
            Route::post("/procedure/section", [
                ProcedureController::class,
                "storeSection",
            ])->name("procedure.section.store");
            Route::put("/procedure/section/{id}", [
                ProcedureController::class,
                "updateSection",
            ])->name("procedure.section.update");
            Route::delete("/procedure/section/{id}", [
                ProcedureController::class,
                "destroySection",
            ])->name("procedure.section.destroy");
            ...
            Route::post("/organization/steering", [
                OperatingModelController::class,
                "storeSteering",
            ])->name("organization.steering.store");
            Route::put("/organization/steering/{id}", [
                OperatingModelController::class,
                "updateSteering",
            ])->name("organization.steering.update");
            Route::delete("/organization/steering/{id}", [
                OperatingModelController::class,
                "destroySteering",
            ])->name("organization.steering.destroy");

            // Matriks RACI (RACI Matrix) mapping
            Route::get("/raci", [PracticeRoleController::class, "index"])->name(
                "raci.index",
            );
            Route::get("/raci/manage", [
                PracticeRoleController::class,
                "manage",
            ])->name("raci.manage");
            Route::post("/raci", [
            ...
            Route::get("/responsible", [
                ...
                "manage",
            ])->name("responsible.manage");
            Route::post("/responsible", [
                ResponsibleController::class,
                "store",
            ])->name("responsible.store");
            Route::put("/responsible/{id}", [
                ResponsibleController::class,
                "update",
            ])->name("responsible.update");
            Route::delete("/responsible/{id}", [
                ResponsibleController::class,
                "destroy",
            ])->name("responsible.destroy");
        });
    ...
    Route::redirect(
        "/program-planning/strategic-house/business-strategy",
        "/strategic-house/business-strategy",
    );
    Route::post("/program-planning/strategic-house/business-strategy", [
        StrategicHouseBusinessStrategyManageController::class,
        "store",
    ]);
    Route::put(
        "/program-planning/strategic-house/business-strategy/bulk-update",
        [StrategicHouseBusinessStrategyManageController::class, "bulkUpdate"],
    );
    Route::put(
        "/program-planning/strategic-house/business-strategy/{businessStrategy}",
        [StrategicHouseBusinessStrategyManageController::class, "update"],
    );
    Route::delete(
        "/program-planning/strategic-house/business-strategy/{businessStrategy}",
        [StrategicHouseBusinessStrategyManageController::class, "destroy"],
    );
    Route::get(
        "/program-planning/strategic-house/initiative-support",
        static fn() => redirect("/strategic-house/initiative-support"),
    );
    Route::post("/program-planning/strategic-house/initiative-support", [
        StrategicHouseInitiativeSupportIndexController::class,
        "store",
    ]);
    Route::post(
        "/program-planning/strategic-house/initiative-support/mappings/delete",
        [
            StrategicHouseInitiativeSupportIndexController::class,
            "destroyMappings",
        ],
    ...
    Route::redirect(
        "/program-planning/strategic-house/roadmap",
        "/strategic-house/roadmap",
    );
    Route::get(
        "/program-planning/strategic-house/roadmap-summary",
        StrategicHouseRoadmapSummaryController::class,
    )->name("program-planning.strategic-house.roadmap-summary.index");
    Route::get(
        "/strategic-pillars/{goal?}",
        StrategicHouseStrategicPillarsIndexController::class,
    );
    Route::post("/strategic-pillars/goals", [
        StrategicHouseStrategicPillarGoalController::class,
        "store",
    ]);
    Route::put("/strategic-pillars/goals/{goal}", [
        StrategicHouseStrategicPillarGoalController::class,
        "update",
    ]);
    Route::delete("/strategic-pillars/goals/{goal}", [
        StrategicHouseStrategicPillarGoalController::class,
        "destroy",
    ]);
    Route::post("/strategic-pillars/themes", [
        StrategicHouseStrategicPillarThemeController::class,
        "store",
    ]);
    Route::put("/strategic-pillars/themes/{theme}", [
        StrategicHouseStrategicPillarThemeController::class,
        "update",
    ]);
    Route::delete("/strategic-pillars/themes/{theme}", [
        StrategicHouseStrategicPillarThemeController::class,
        "destroy",
    ]);
    Route::post("/strategic-pillars/tagging", [
        StrategicHouseInitiativeTaggingController::class,
        "store",
    ]);
    Route::delete("/strategic-pillars/tagging/{tagging}", [
        StrategicHouseInitiativeTaggingController::class,
        "destroy",
    ]);
    ...
    Route::get("/roadmap", [RoadmapController::class, "index"])->name(
        "roadmap.index",
    );
    Route::get("/roadmap/add", [RoadmapController::class, "add"])->name(
        "roadmap.add",
    );
    Route::get("/roadmap/edit", [RoadmapController::class, "edit"])->name(
        "roadmap.edit",
    );
    Route::get("/roadmap/initiative/{initiative}", [
    ...
    Route::resource(
        "it-initiatives",
        ITInitiativeController::class,
    )->parameters(["it-initiatives" => "project"]);
    Route::post("/it-initiatives/{project}/charter", [
        CharterController::class,
        "store",
    ])->name("it-initiatives.charter.store");
    Route::put("/it-initiatives/{project}/charter/{charter}", [
        CharterController::class,
        "update",
    ])->name("it-initiatives.charter.update");
    Route::post("/it-initiatives/{project}/version-analysis", [
        VersionAnalysisController::class,
        "store",
    ])->name("it-initiatives.version-analysis.store");
    Route::put("/it-initiatives/{project}/version-analysis/{analysis}", [
        VersionAnalysisController::class,
        "update",
    ])->name("it-initiatives.version-analysis.update");
    Route::post("/it-initiatives/{project}/milestones/versions", [
        MilestoneController::class,
        "createVersion",
    ])->name("it-initiatives.milestones.versions.store");
    Route::post("/it-initiatives/{project}/milestones", [
        MilestoneController::class,
        "store",
    ])->name("it-initiatives.milestones.store");
    Route::put("/it-initiatives/{project}/milestones/{milestone}", [
        MilestoneController::class,
        "update",
    ])->name("it-initiatives.milestones.update");
    Route::delete("/it-initiatives/{project}/milestones/{milestone}", [
        MilestoneController::class,
        "destroy",
    ])->name("it-initiatives.milestones.destroy");
    Route::post("/it-initiatives/{project}/implementation-status", [
        ITInitiativeController::class,
        "storeImplementationStatus",
    ])->name("it-initiatives.implementation-status.store");

    Route::put("/implementation-status/{id}", [
        ITInitiativeController::class,
        "updateImplementationStatus",
    ])->name("it-initiatives.implementation-status.update");
    Route::delete("/implementation-status/{id}", [
        ITInitiativeController::class,
        "destroyImplementationStatus",
    ])->name("it-initiatives.implementation-status.destroy");
    Route::put("/it-initiatives/{project}/project-status-history/{history}", [
        ITInitiativeController::class,
        "updateProjectStatusHistory",
    ])->name("it-initiatives.project-status-history.update");
    Route::delete(
    ...
    Route::put("/it-initiatives/{project}/mapping", [
        ITInitiativeController::class,
        "updateMapping",
    ])->name("it-initiatives.mapping.update");
    ...
    Route::get("/libary", [LibaryController::class, "index"])->name(
        "libary.index",
    );
    Route::post("/libary/upload", [LibaryController::class, "upload"])->name(
        "libary.upload",
    );
    Route::get("/libary/document/{uuid}/preview", [
        LibaryController::class,
        "previewFile",
    ])->name("libary.document.preview");
    Route::get("/libary/document/{uuid}/download", [
        LibaryController::class,
        "downloadFile",
    ])->name("libary.document.download");
    Route::delete("/libary/document/{uuid}", [
        LibaryController::class,
        "destroy",
    ])->name("libary.document.destroy");
    Route::get("/libary/{uuid}", [LibaryController::class, "show"])->name(
        "libary.show",
    );
    ...
    Route::prefix("/bpmn-workflow")
        ->name("bpmn-workflow.")
        ->group(function () {
            Route::get("/", [BpmnWorkflowController::class, "index"])->name(
                "index",
            );
            Route::post("/", [BpmnWorkflowController::class, "store"])->name(
                "store",
            );
            Route::delete("/{bpmnWorkflow}", [
                BpmnWorkflowController::class,
                "destroy",
            ])->name("destroy");
            Route::post("/trigger-action", [
                BpmnWorkflowController::class,
                "triggerAction",
            ])->name("trigger-action");
            Route::post("/{id}/sync-from-sop", [
                BpmnWorkflowController::class,
                "syncFromSop",
            ])->name("sync-from-sop");
        });
