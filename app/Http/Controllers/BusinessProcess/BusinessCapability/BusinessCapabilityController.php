...
namespace App\Http\Controllers\BusinessProcess\BusinessCapability;
...
class BusinessCapabilityController extends Controller
{
    ...
    {
        return Inertia::render('BusinessProcess/BusinessCapability/Index', [
    ...
    ): RedirectResponse
    {
        ...
        return redirect()
            ->route('business-process.business-capability.index')
