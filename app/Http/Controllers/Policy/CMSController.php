...
class CMSController extends Controller
{
        ...
        $documents = Document::where('entity_type', 'regulation')
            ...
            ->map(function ($doc) {
                return [
                    ...
                    'url' => route('libary.document.preview', ['uuid' => $doc->uuid]),
                ];
            });

        return Inertia::render('Policy/CMS/Index', [
            'documents' => $documents,
    ...
    public function show(Request $request, $uuid)
    {
        ...
        return Inertia::render('Policy/CMS/Index', [
            ...
            'selectedDocument' => [
                ...
                'url' => route('libary.document.preview', ['uuid' => $selectedDoc->uuid]),
            ]
        ]);
    }
    ...
    public function upload(Request $request)
    {
        ...
        return redirect()->route('policy.CMS.show', ['uuid' => $uuid])
    ...
    public function destroy($uuid)
    {
        ...
        return redirect()->route('policy.CMS.index')
