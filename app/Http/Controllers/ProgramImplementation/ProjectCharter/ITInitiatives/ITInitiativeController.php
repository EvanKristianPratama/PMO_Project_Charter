...
class ITInitiativeController extends Controller
{
    ...
    {
        return Inertia::render(
            'ProgramImplementation/ProjectCharter/ITInitiatives/Create',
    ...
    {
        return Inertia::render(
            'ProgramImplementation/ProjectCharter/ITInitiatives/Show',
    ...
    {
        return Inertia::render(
            'ProgramImplementation/ProjectCharter/ITInitiatives/Edit',
