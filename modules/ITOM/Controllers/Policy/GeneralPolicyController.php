...
class GeneralPolicyController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('modules/ITOM/Policy/Guidance/General/Index', [
            'policies' => $policies,
    ...
    public function manage(Request $request): Response
    {
        ...
        return Inertia::render('modules/ITOM/Policy/Guidance/General/Manage', [
            'policies' => $policies,
            'objectives' => $objectives,
            'regulations' => $regulations,
            'selectedRegulationId' => $selectedRegulation?->id,
    ...
    public function introduction(): Response
    {
        ...
        return Inertia::render('modules/ITOM/Policy/Guidance/Introduction/Index', [
            'regulations' => $regulations,
            'selectedRegulationId' => $selectedRegulation?->id,
        ]);
    }
    ...
    public function closing(): Response
    {
        ...
        return Inertia::render('modules/ITOM/Policy/Guidance/Closing', [
            'regulations' => $regulations,
            'selectedRegulationId' => $selectedRegulation?->id,
        ]);
    }
