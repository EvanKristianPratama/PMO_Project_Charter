...
class TktiInformationFlowController extends Controller
{
    /**
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('modules/ITOM/RaciAnalysis/ItspInfoflow/Index', [
    ...
    public function manage(): Response
    {
        ...
        return Inertia::render('modules/ITOM/RaciAnalysis/ItspInfoflow/Manage', [
            'inputs' => $inputs,
            'outputs' => $outputs,
            'practices' => $practices,
