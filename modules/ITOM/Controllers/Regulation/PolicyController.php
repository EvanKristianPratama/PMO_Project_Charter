...
class PolicyController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('modules/ITOM/Regulation/PolicyStandartProcedure/Guidance/Specific/Index', [
    ...
    public function createObjective(Request $request): Response
    {
        ...
        return Inertia::render('modules/ITOM/Regulation/PolicyStandartProcedure/Guidance/Specific/Form', [
            'objectives' => $objectives,
            'regulations' => $regulations,
            'selectedRegulationId' => $selectedRegulation?->id,
            'initCreate' => true,
    ...
    public function mappingCobit(Request $request): Response
    {
        ...
        return Inertia::render('modules/ITOM/Regulation/PolicyStandartProcedure/Guidance/Specific/Mapping', [
            'objectives' => $objectives,
            'regulations' => $regulations,
            'selectedRegulationId' => $selectedRegulation?->id,
    ...
    public function mappingCobitAnalysis(Request $request): Response
    {
        ...
        return Inertia::render('modules/ITOM/Regulation/PolicyStandartProcedure/Guidance/Specific/Analysis', [
            'objectives' => $objectives,
            'regulations' => $regulations,
            'selectedRegulationId' => $selectedRegulation?->id,
        ]);
    ...
    public function storeObjective(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('itom.policy.specific.edit', ['objective' => $objective->objective_id])
    ...
    public function updateObjective(Request $request, string $id): RedirectResponse
    {
        ...
        return redirect()
            ->route('itom.policy.specific.manage', ['regulation_id' => $request->regulation_id])
    ...
    public function destroyObjective(string $id): RedirectResponse
    {
        ...
        return redirect()
            ->route('itom.policy.specific.manage', ['regulation_id' => $regulationId])
    ...
    public function storePractice(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('itom.policy.specific.edit', ['objective' => $request->objective_id])
    ...
    public function updatePractice(Request $request, string $id): RedirectResponse
    {
        ...
        return redirect()
            ->route('itom.policy.specific.edit', ['objective' => $objectiveId])
    ...
    public function storeCobitMapping(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('itom.policy.specific.mapping', [
