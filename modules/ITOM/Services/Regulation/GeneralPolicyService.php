...
class GeneralPolicyService
{
     ...
     *
     * @param array $data
     * @return MstGeneralPolicy
     */
    public function createGeneralPolicy(array $data): MstGeneralPolicy
    {
        return MstGeneralPolicy::create($data);
    }

    /**
     * Update the specified general policy.
     *
     * @param MstGeneralPolicy $policy
     * @param array $data
     * @return MstGeneralPolicy
     */
    public function updateGeneralPolicy(MstGeneralPolicy $policy, array $data): MstGeneralPolicy
    {
        $policy->update($data);
        return $policy;
    }
     ...
     * @return void
     */
    public function deleteGeneralPolicy(MstGeneralPolicy $policy): void
    {
        $policy->delete();
    }

    /**
     * Get guidance chapter details (Introduction / Closing).
     *
     * @return array
     */
    public function getGuidanceChapterData(): array
    {
        try {
