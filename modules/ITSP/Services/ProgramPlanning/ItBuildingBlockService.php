...
namespace Modules\ITSP\Services\ProgramPlanning;
...
class ItBuildingBlockService
{
    ...
    {
        return Cache::remember('it_building_block_coe_options', 3600, function () {
            return MstCoe::query()
                ->orderBy('name')
                ->get(['id', 'name'])
    ...
    {
        return Cache::remember('it_building_block_it_initiative_options', 3600, function () {
    ...
    {
        return Cache::remember('it_building_block_status_periods', 3600, function () {
            return \Modules\ITSP\Models\TrsStatusImplementation::query()
    ...
    {
        return Cache::remember('it_building_block_digital_initiative_options', 3600, function () {
            return MstInitiative::query()
                ->with([
                    'coe:id,name',
                    'organization:id,name,groub_id',
    ...
    {
        return Cache::remember('it_building_block_grouped_mappings', 3600, function () {
