<template>
    <div class="space-y-6">
        ...
        <div v-if="showModal" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div class="relative w-full max-w-lg animate-fade-in-up rounded-2xl bg-white p-6 shadow-2xl dark:bg-[#1a1a1a]">
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    <div>
                        <label class="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Organisasi</label>
                        <select
                        ...
                        <p v-if="form.errors.organization_id" class="mt-1 text-xs text-rose-500">{{ form.errors.organization_id }}</p>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">No</label>
                            <input
                                v-model="form.no"
                                type="text"
                                class="w-full rounded-lg border-slate-200 bg-slate-50 text-sm focus:border-[#821f44] focus:ring-[#821f44] dark:border-white/10 dark:bg-white/5 dark:text-white"
                    ...
                    <div>
                        <label class="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Proses Bisnis</label>
                        <input
                            v-model="form.proses_bisnis"
                            type="text"
                            class="w-full rounded-lg border-slate-200 bg-slate-50 text-sm focus:border-[#821f44] focus:ring-[#821f44] dark:border-white/10 dark:bg-white/5 dark:text-white"
                            placeholder="Judul Proses Bisnis"
                            required
                        />
                        <p v-if="form.errors.proses_bisnis" class="mt-1 text-xs text-rose-500">{{ form.errors.proses_bisnis }}</p>
                    </div>

                    <div>
                        <label class="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Tugas</label>
                        <textarea
                            v-model="form.tugas"
                            rows="3"
                            class="w-full rounded-lg border-slate-200 bg-slate-50 text-sm focus:border-[#821f44] focus:ring-[#821f44] dark:border-white/10 dark:bg-white/5 dark:text-white"
                    ...
                    <div>
                        <label class="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Hasil</label>
                        <textarea
                            v-model="form.hasil"
                            rows="3"
                            class="w-full rounded-lg border-slate-200 bg-slate-50 text-sm focus:border-[#821f44] focus:ring-[#821f44] dark:border-white/10 dark:bg-white/5 dark:text-white"
                            placeholder="Hasil/Output"
                            required
                        ></textarea>
