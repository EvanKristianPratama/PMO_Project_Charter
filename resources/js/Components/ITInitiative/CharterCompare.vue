...
const fields = [
    ...
    { key: 'background', fieldLabel: 'Background', previousLabel: 'Latar belakang - Gap/peluang saat ini', currentLabel: 'Background', multiline: true },
    { key: 'objectives', fieldLabel: 'Objectives', previousLabel: 'Tujuan', currentLabel: 'Objectives', multiline: true },
    ...
    { key: 'impact_value', fieldLabel: 'Impact Value', previousLabel: 'Dampak dan nilai bagi Pertamina', currentLabel: 'Impact Value', multiline: true },
    { key: 'key_personnel', fieldLabel: 'Key Personnel', previousLabel: 'Personel Utama', currentLabel: 'Cross Functional Involvement', multiline: true, showTerminologyRow: true },
    { key: 'key_items', fieldLabel: 'Key Items', previousLabel: 'Item Utama', currentLabel: 'Required Resources', multiline: true },
    { key: 'budget', fieldLabel: 'Budget', previousLabel: 'Indikatif Kebutuhan Budget', currentLabel: 'Budget' },
    { key: 'risks_identified', fieldLabel: 'Risks Identified', previousLabel: 'Resiko Teridentifikasi', currentLabel: 'Risks Identified', multiline: true },
    { key: 'risk_mitigation', fieldLabel: 'Risk Mitigation', previousLabel: 'Mitigasi Resiko', currentLabel: 'Risk Mitigation', multiline: true },
