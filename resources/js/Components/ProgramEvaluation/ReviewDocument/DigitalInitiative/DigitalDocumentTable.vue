                    ...
                    <tbody class="bg-white dark:bg-[#171717] divide-y divide-slate-900 dark:divide-white/20">
                        <template v-for="project in filteredProjects" :key="project.id">
                            ...
                            <tr v-if="expandedRows.has(project.id)"
                                ...
                                <td colspan="6" class="px-6 py-6 border-r border-slate-900 dark:border-white/20">
...
import ITDocumentStatistik from '../ITInitiative/ITDocumentStatistik.vue';
import ITCompletenessChart from '../ITInitiative/ITCompletenessChart.vue';
