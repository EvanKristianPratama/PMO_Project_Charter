<template>
    <section v-if="data.length > 0" class="mt-8 overflow-hidden animate-fade-in-up delay-150">
        <div class="overflow-x-auto rounded-2xl border border-slate-900 shadow-sm dark:border-white/20">
            <table class="w-full border-collapse text-left text-[11px]">
                ...
                <tbody class="bg-white dark:bg-[#171717]">
                    <tr v-for="row in data" :key="row.leader" class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
