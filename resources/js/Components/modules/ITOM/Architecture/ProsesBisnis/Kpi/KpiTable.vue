...
const submitForm = () => {
    if (modalMode.value === 'create') {
        form.post(route('itom.business-process.kpi.store'), {
            onSuccess: () => {
        ...
        form.put(route('itom.business-process.kpi.update', selectedKpi.value.id), {
            onSuccess: () => {
                isModalOpen.value = false;
                form.reset();
            },
...
const submitDelete = () => {
    form.delete(route('itom.business-process.kpi.destroy', selectedKpi.value.id), {
        onSuccess: () => {
