...
function submitDiagramForm() {
    ...
    if (editingDiagramId.value) {
        diagramForm.put(route('itom.policy.procedure.diagram.update', editingDiagramId.value), {
            preserveScroll: true,
            onSuccess: () => {
        ...
        diagramForm.post(route('itom.policy.procedure.diagram.store'), {
            preserveScroll: true,
            onSuccess: () => {
                activeFlowType.value = savedType;
                closeDiagramModal();
...
function submitDeleteDiagram() {
    ...
    diagramForm.delete(route('itom.policy.procedure.diagram.destroy', selectedDiagramMapping.value.id), {
        preserveScroll: true,
        onSuccess: () => {
