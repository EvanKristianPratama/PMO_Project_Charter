<template>
    <div class="animate-fade-in-up space-y-6">
            ...
            <div class="max-w-4xl mx-auto bg-white dark:bg-[#1a1a1a] shadow-xl border border-slate-200 dark:border-white/10 p-6 sm:p-8 md:p-10 rounded-2xl relative font-sans text-slate-800 dark:text-slate-200 print:shadow-none print:border-none print:p-0 print:m-0">
                ...
                <!-- Document Body -->
                <div class="mt-10 space-y-8 text-[15px] leading-relaxed text-slate-900 dark:text-slate-100 relative z-10 font-serif text-justify">
                    
                    <!-- Ketentuan Peralihan -->
                    <div class="space-y-3">
                        <h3 class="text-[16px] font-bold text-slate-950 dark:text-white font-sans border-b border-slate-900/10 pb-2 dark:border-white/10">
