...
const submitForm = () => {
    if (modalMode.value === 'create') {
        form.post(route('itom.business-process.organization-structure.functional.store'), {
            onSuccess: () => {
        ...
        form.put(route('itom.business-process.organization-structure.functional.update', selectedFunctional.value.id), {
            onSuccess: () => {
                isModalOpen.value = false;
                form.reset();
            },
...
const submitDelete = () => {
    form.delete(route('itom.business-process.organization-structure.functional.destroy', selectedFunctional.value.id), {
        onSuccess: () => {
