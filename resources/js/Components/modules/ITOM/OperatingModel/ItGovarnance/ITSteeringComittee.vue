...
const submitForm = () => {
    if (modalMode.value === 'create') {
        form.post(route('itom.operating-model.it-governance.steering.store'), {
            onSuccess: () => {
        ...
        form.put(route('itom.operating-model.it-governance.steering.update', selectedItem.value.id), {
            onSuccess: () => {
                isModalOpen.value = false;
                form.reset();
            },
...
const submitDelete = () => {
    form.delete(route('itom.operating-model.it-governance.steering.destroy', selectedItem.value.id), {
        onSuccess: () => {
