...
const initiativeSummaryHref = (initiative) => {
    ...
    return initiativeId > 0
        ? route('itsp.program-planning.program-definition.digital-initiatives.summary.index', initiativeId)
        : null;
};
...
const initiativeProjectCharterHref = (initiative) => {
    ...
    return projectId > 0
        ? route('itsp.it-initiatives.show', { project: projectId, tab: 'charter' })
        : null;
};
...
const submitMapping = () => {
    ...
    router.post(route('itsp.program-planning.it-building-blocks.store'), {
...
const confirmDeletePrimary = () => {
    ...
    router.delete(route('itsp.program-planning.it-building-blocks.primary.destroy', {
...
const confirmDeleteSecondary = () => {
    ...
    router.delete(route('itsp.program-planning.it-building-blocks.secondary.destroy', {
        primary: deleteTarget.group.primary_id,
...
const savePendingInitiativeRemovals = () => {
    ...
    router.post(route('itsp.program-planning.it-building-blocks.initiative.bulk-destroy'), {
