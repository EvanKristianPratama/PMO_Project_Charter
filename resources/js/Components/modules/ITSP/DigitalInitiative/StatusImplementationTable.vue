...
import StatusImplementationModal from '@/Components/modules/ITSP/DigitalInitiative/StatusImplementationModal.vue';
...
const deleteItem = (item) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(route('itsp.digital-initiatives.implementation-status.destroy', item.id), {
                preserveScroll: true,
                onSuccess: () => {
                    Swal.fire({
                        title: 'Terhapus!',
