...
const submit = () => {
    ...
    if (isEditing.value) {
        submissionForm.put(
            route('itsp.digital-initiatives.implementation-status.update', props.statusData.id),
            requestOptions,
        );
    ...
    submissionForm.post(route('itsp.digital-initiatives.implementation-status.store'), requestOptions);
};
