                    ...
                    <tr v-for="(project, index) in items" :key="`it-open-${project.id}`" class="group transition-colors hover:bg-slate-50 dark:hover:bg-white/5">
                        ...
                        <td class="px-3 py-3 text-[10px] font-medium">
                            <div class="flex flex-col items-start gap-1">
                                <Link
                                    :href="route('itsp.it-initiatives.edit', project.id)"
                                ...
                                <Link
                                    :href="route('itsp.it-initiatives.show', { project: project.id, tab: 'charter' })"
                                ...
                                <Link
                                    :href="route('itsp.it-initiatives.show', { project: project.id, tab: 'detail' })"
