    ...
    <article class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#171717]">
        <div class="border-b border-slate-200 px-5 py-4 dark:border-white/10">
            <div class="flex items-center justify-between gap-3">
                ...
                <Link
                    :href="route('itsp.digital-initiatives.index', { status: completedStatusId })"
            ...
            <table class="w-full table-fixed divide-y divide-slate-200 text-[11px] dark:divide-white/5">
                ...
                <thead class="bg-slate-50 dark:bg-white/5">
                    <tr>
                        ...
                        <th class="px-3 py-2 text-left align-top text-[10px] font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Arsitektur Digital Building Blok</th>
                ...
                <tbody class="divide-y divide-slate-200 bg-white dark:divide-white/5 dark:bg-[#1a1a1a]">
                    <tr v-for="(project, index) in items" :key="`digital-open-${project.id}`" class="group transition-colors hover:bg-slate-50 dark:hover:bg-white/5">
