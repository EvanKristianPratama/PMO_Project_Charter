...
const createRow = () => {
    createForm.post(route('business-process.business-capability.store'), {
        preserveScroll: true,
        onSuccess: () => {
            resetCreate();
...
const saveEdit = () => {
    ...
    editForm.put(route('business-process.business-capability.update', editingId.value), {
        preserveScroll: true,
...
const executeDelete = () => {
    ...
    deleteForm.delete(route('business-process.business-capability.destroy', deleteTarget.value.id), {
        preserveScroll: true,
        onSuccess: () => {
