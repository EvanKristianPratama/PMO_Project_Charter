<template>
    <UserLayout title="Peran dan Tanggung Jawab">
        <div class="space-y-6 animate-fade-in-up print:m-0 print:p-0">
            ...
            <div class="max-w-4xl mx-auto bg-white dark:bg-[#1a1a1a] shadow-xl border border-slate-200 dark:border-white/10 p-8 sm:p-12 md:p-16 rounded-2xl relative text-justify print:shadow-none print:border-none print:p-0 print:m-0"
...
// Letter numbering utility for roles (A, B, C, ...)
