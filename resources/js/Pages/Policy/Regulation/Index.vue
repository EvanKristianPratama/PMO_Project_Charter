    ...
    <ModulLayout title="Regulation">
        <div class="animate-fade-in-up space-y-6">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <div class="flex items-center gap-1 rounded-xl bg-slate-100 p-0.5 dark:bg-white/5 shrink-0">
                    <button
                ...
                <div class="relative flex-1 min-w-[160px] max-w-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="pointer-events-none absolute inset-y-0 left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400">
                ...
                <div class="relative inline-block text-left shrink-0">
                    ...
                    >
                        <span class="truncate">
                            {{ selectedStatuses.length === 0 ? 'Semua Status' : selectedStatuses.length + ' Status' }}
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-3.5 h-3.5 text-slate-400 shrink-0">
                    ...
                    <div v-if="isStatusDropdownOpen" class="absolute left-0 mt-1 w-40 rounded-lg bg-white border border-slate-200 shadow-lg dark:bg-[#1a1a1a] dark:border-white/10 z-40 p-1.5 space-y-0.5">
                        <label
                        ...
                        <div v-if="selectedStatuses.length > 0" class="border-t border-slate-100 dark:border-white/5 pt-1 mt-0.5 flex justify-end">
                            <button
                                type="button"
