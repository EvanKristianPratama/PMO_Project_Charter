                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 divide-y md:divide-y-0 md:divide-x divide-slate-900 dark:divide-white">
                        ...
                        <div class="md:col-span-7 flex flex-col divide-y divide-slate-900 dark:divide-white">
                            <div class="p-3 flex items-start gap-1.5 min-h-[46px]">
                                ...
                                <span class="font-bold text-slate-900 dark:text-white">ENTERPRISE IT – DIREKTORAT PENUNJANG BISNIS</span>
                            </div>
                            <div class="p-3 flex items-start gap-1.5 min-h-[46px]">
                                <span class="font-bold shrink-0">JUDUL :</span>
                                <span class="font-bold text-slate-900 dark:text-white">MATRIKS RACI PERAN DAN TATA KELOLA TIK</span>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-5 flex flex-col divide-y divide-slate-900 dark:divide-white">
                            <div class="p-2.5 flex items-center gap-1.5 min-h-[23px]">
                                <span class="font-bold shrink-0">DOKUMEN :</span>
                                <span class="font-mono font-bold text-slate-900 dark:text-white">TATA KELOLA TIK COBIT 2019</span>
                            </div>
                            ...
                            <div class="p-2.5 flex items-center gap-1.5 min-h-[23px]">
                                <span class="font-bold shrink-0">TANGGAL :</span>
                                <span class="font-bold text-slate-900 dark:text-white">{{ getCurrentDate() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
