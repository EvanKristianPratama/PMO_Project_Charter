...
const crudNav = [
    ...
    { label: 'Business Capability', href: '/master-data/business-capabilities', icon: 'M4 6h16M4 12h16M4 18h16' },
    ...
    { label: 'Log Aktivitas',     href: '/master-data/log-aktivitas',            icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
];
