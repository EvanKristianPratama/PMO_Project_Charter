<template>
    <ModulLayout title="Program Definition Digital Initiatives — Appendix List">
                            ...
                            <tr v-for="(item, index) in filteredAppendixItems" :key="`appendix-${item.id}`" class="transition-colors hover:bg-slate-50 dark:hover:bg-white/5">
                                ...
                                <td class="px-3 py-3 text-[10px] font-medium">
                                    <Link
                                        ...
                                        :href="route('itsp.program-planning.program-definition.digital-initiatives.appendix.edit', resolveDetailId(item))"
