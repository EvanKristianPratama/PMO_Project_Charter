        ...
        <div class="mx-auto max-w-7xl space-y-5">
            <section class="print:hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-[#171717]">
                <div class="flex items-center justify-between mb-1">
                    <Link :href="route('itsp.roadmap.index')" class="text-sm font-medium text-[#0B2A8A] hover:underline dark:text-[#53BDE6]">
                        ← Semua Roadmap
                    </Link>
                </div>
            ...
            <template v-if="program.projects && program.projects.length">
                ...
                >
                    <div class="mb-3 flex items-center justify-between gap-2">
                        ...
                        <Link
                            :href="route('itsp.roadmap.edit', { pc_id: project.charter?.id ?? project.id })"
