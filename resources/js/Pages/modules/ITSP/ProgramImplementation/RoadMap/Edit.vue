<template>
    <ModulLayout title="Roadmap Input & Edit">
        <div class="space-y-5 print:space-y-0">
            <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-[#171717]">
                <div class="mb-4 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        <Link :href="route('itsp.roadmap.index')" class="mb-2 inline-flex text-sm font-medium text-[#0B2A8A] hover:underline dark:text-[#53BDE6]">
                            Kembali
                        </Link>
