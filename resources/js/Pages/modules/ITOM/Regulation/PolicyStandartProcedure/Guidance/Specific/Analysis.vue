            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        <Link :href="route('itom.policy.specific.mapping', { regulation_id: selectedRegulationId })" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
...
const changeRegulation = () => {
    router.visit(route('itom.policy.specific.mapping.analysis'), {
