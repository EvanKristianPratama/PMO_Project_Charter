    ...
    <ModulLayout title="CMS - Document Management">
        <div class="animate-fade-in-up space-y-6 -mx-4 sm:-mx-6 lg:-mx-8 -mt-5">
            ...
            <div class="px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <Deferred :data="['documents', 'regulationOptions']">
                    <template #fallback>
                        <TableSkeleton />
                    </template>

                    <Document :documents="documents" :regulation-options="regulationOptions" />
                </Deferred>
            </div>
        </div>
    </ModulLayout>
...
import Document from '@/Components/modules/ITOM/Regulation/CMS/Document/Document.vue';
