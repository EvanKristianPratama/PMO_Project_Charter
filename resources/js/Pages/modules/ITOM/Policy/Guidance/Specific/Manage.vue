            ...
            <section class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#171717]">
                ...
                <div class="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <Link
                            :href="route('itom.policy.specific.mapping', { regulation_id: props.selectedRegulationId || activeRegulation?.id })"
                        ...
                        <Link
                            :href="route('itom.policy.specific.create', { regulation_id: props.selectedRegulationId || activeRegulation?.id })"
