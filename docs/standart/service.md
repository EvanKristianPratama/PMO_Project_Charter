...
Jika frontend hanya membutuhkan `foreign_key` (seperti `parent_id`) untuk menyusun hierarki secara mandiri di sisi client, memuat objek relasi penuh (`parent` relation) adalah pemborosan:
